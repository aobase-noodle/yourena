...
- 基本台5 台及以上（因为明台6台就可以变为15台，算大翻）
- 三美人、四美人、四风齐（差一种牌面：如三美人已经有三白板三红中；四风齐已经有三种牌面）
- 三杠头、四白板、单吊（已成型）
...
2. 破翻相关：
    ...
    - 差一种牌面
      ...
      比如A 明面牌中已有3 白板，3红中，出现破翻情况。然后B 打了发财，A 凑出3发财，此时或者后面A 胡了。则B 包牌

      四风齐类似。

    - 已成型（单吊）

      A 只剩一对牌，此时打出一张牌a，然后A 再次摸牌前B 打了a 的牌面值前后两位的牌，此时A 胡了。则B 包牌
